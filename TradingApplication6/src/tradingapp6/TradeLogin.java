...
public class TradeLogin {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TradeLogin window = new TradeLogin();
	...
	private void initialize() {
		...
		frmEstoreTradingSoftware.setBounds(400, 250, 560, 316);
		...
		btnLogin.setBounds(363, 147, 100, 27);
		...
		btnChangePassword.setForeground(new Color(255, 0, 153));
		btnChangePassword.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnChangePassword.setBounds(325, 202, 182, 23);
		frmEstoreTradingSoftware.getContentPane().add(btnChangePassword);
		
		JLabel lblCopyRights = new JLabel("@CopyRights : New Vision");
		lblCopyRights.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblCopyRights.setBounds(382, 252, 152, 14);
