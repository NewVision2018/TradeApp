...
public class TradeSCTaxExcelReport extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TradeSCTaxExcelReport frame = new TradeSCTaxExcelReport();
	...
	public void refreshTable(){
		...
		try{
			...
			String query = "SELECT BILL_NO,NAME,GSTN,DATE,SALE_5,SGST_2_5,CGST_2_5,SALE_12,SGST_6,CGST_6,SALE_18,SGST_9,CGST_9,SALE_28,SGST_14,CGST_14 FROM TaxSummary ORDER BY DATE ASC";
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try{
					...
					String query = "SELECT * FROM TaxSummary WHERE BILL_NO='"+billNo+"'";
		...
		btnCheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					...
					String query = "SELECT BILL_NO,NAME,GSTN,DATE,SALE_5,SGST_2_5,CGST_2_5,SALE_12,SGST_6,CGST_6,SALE_18,SGST_9,CGST_9,SALE_28,SGST_14,CGST_14 FROM TaxSummary WHERE DATE BETWEEN '"+fromDate+"' AND '"+toDate+"' ORDER BY DATE ASC";
		...
		btnExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					...
					rowHead.createCell((short) 5).setCellValue("SGST@2.5");
					rowHead.createCell((short) 6).setCellValue("CGST@2.5");
					rowHead.createCell((short) 7).setCellValue("SALE@12");
					rowHead.createCell((short) 8).setCellValue("SGST@6");
					rowHead.createCell((short) 9).setCellValue("CGST@6");
					rowHead.createCell((short) 10).setCellValue("SALE@18");
					rowHead.createCell((short) 11).setCellValue("SGST@9");
					rowHead.createCell((short) 12).setCellValue("CGST@9");
					rowHead.createCell((short) 13).setCellValue("SALE@28");
					rowHead.createCell((short) 14).setCellValue("SGST@14");
					rowHead.createCell((short) 15).setCellValue("CGST@14");
					
					String query = "SELECT BILL_NO,NAME,GSTN,DATE,SALE_5,SGST_2_5,CGST_2_5,SALE_12,SGST_6,CGST_6,SALE_18,SGST_9,CGST_9,SALE_28,SGST_14,CGST_14 FROM TaxSummary WHERE DATE BETWEEN '"+fromDate+"' AND '"+toDate+"'";
					...
					while(rs.next()){
						...
						row.createCell((short) 5).setCellValue(rs.getString("SGST_2_5"));
						row.createCell((short) 6).setCellValue(rs.getString("CGST_2_5"));
						row.createCell((short) 7).setCellValue(rs.getString("SALE_12"));
						row.createCell((short) 8).setCellValue(rs.getString("SGST_6"));
						row.createCell((short) 9).setCellValue(rs.getString("CGST_6"));
						row.createCell((short) 10).setCellValue(rs.getString("SALE_18"));
						row.createCell((short) 11).setCellValue(rs.getString("SGST_9"));
						row.createCell((short) 12).setCellValue(rs.getString("CGST_9"));
						row.createCell((short) 13).setCellValue(rs.getString("SALE_28"));
						row.createCell((short) 14).setCellValue(rs.getString("SGST_14"));
						row.createCell((short) 15).setCellValue(rs.getString("CGST_14"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!billNoSelected.equals("") && !nameSelected.equals("") && !gstnSelected.equals("")){
					...
					try{
						...
						String query = "DELETE FROM TaxSummary WHERE BILL_NO='"+billNoSelected+"' AND NAME='"+nameSelected+"' AND GSTN='"+gstnSelected+"'";
