...
public class TradeBillReceipt extends JFrame {
	...
	public TradeBillReceipt(TradeReceiptPojo trp) {
		...
		discount = String.format("%.3f", Double.valueOf(trp.getTextFieldSubTotal()) - Double.valueOf(trp.getTextFieldDiscount()));
		else
		discount = "0.0";
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//	Rectangle rectangle = new Rectangle(158, 13, 405, 707);
					...
					BufferedImage billImage = robot.createScreenCapture(rectangle);
					...
					JOptionPane.showMessageDialog(null, "Bill Saved as PDF in "+ filePath);
