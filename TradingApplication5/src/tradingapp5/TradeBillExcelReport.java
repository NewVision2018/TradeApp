...
import tradingapp5.SQLiteConnection;
...
public class TradeBillExcelReport extends JFrame {
	...
	public void refreshTable(){
		...
		try{
			...
			String query = "SELECT BILL_NO, NAME, GSTIN, DATE, TOTAL_QTY, GRAND_TOTAL FROM Users ORDER BY DATE ASC";
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try{
					...
					while(rs.next()){
						...
						gstnSelected = rs.getString("GSTIN");
		...
		btnCheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					...
					String query = "SELECT BILL_NO, NAME, GSTIN, DATE, TOTAL_QTY, GRAND_TOTAL FROM Users WHERE DATE BETWEEN '"+fromDate+"' AND '"+toDate+"' ORDER BY DATE ASC";
		...
		btnExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					...
					rowHead.createCell((short) 2).setCellValue("GSTIN");
					rowHead.createCell((short) 3).setCellValue("DATE");
					rowHead.createCell((short) 4).setCellValue("TOTAL QTY");
					rowHead.createCell((short) 5).setCellValue("GRAND TOTAL");
					
					String query = "SELECT BILL_NO, NAME, GSTIN, DATE, TOTAL_QTY, GRAND_TOTAL FROM Users WHERE DATE BETWEEN '"+fromDate+"' AND '"+toDate+"'";
					...
					while(rs.next()){
						...
						row.createCell((short) 2).setCellValue(rs.getString("GSTIN"));
						row.createCell((short) 3).setCellValue(rs.getString("DATE"));
						row.createCell((short) 4).setCellValue(rs.getString("TOTAL_QTY"));
						row.createCell((short) 5).setCellValue(rs.getString("GRAND_TOTAL"));
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!billNoSelected.equals("") && !nameSelected.equals("") && !gstnSelected.equals("")){
					...
					try{
						...
						String query = "DELETE FROM Users WHERE BILL_NO='"+billNoSelected+"' AND NAME='"+nameSelected+"' AND GSTIN='"+gstnSelected+"'";
